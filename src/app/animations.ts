...
function stepper(){
  ...
  return[
    group([
      ...
      query('.gallery-info *, .slide_thumbs, footer', style({ opacity: 0 })
      , optional),
  
      query(':enter .gallery-info *, .slide_thumbs, footer', stagger(100, [
...
function galleryAway(){
  ...
  return[
    //transition(':leave', [
    group([
      query(':leave .gallery-info *, .slide_thumbs, footer', stagger(10, [
